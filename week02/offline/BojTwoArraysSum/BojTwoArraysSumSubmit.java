// Full verification - like 'Submit' on Programmers. To run samples only, run BojTwoArraysSumTest.
...
public class BojTwoArraysSumSubmit {
    static final String NAME = "BojTwoArraysSum";
