// Full verification - like 'Submit' on Programmers. To run samples only, run BojColorWheelTest.
...
public class BojColorWheelSubmit {
    static final String NAME = "BojColorWheel";
