// Full verification - like 'Submit' on Programmers. To run samples only, run BojSpecificShortestPathTest.
...
public class BojSpecificShortestPathSubmit {
    static final String NAME = "BojSpecificShortestPath";
