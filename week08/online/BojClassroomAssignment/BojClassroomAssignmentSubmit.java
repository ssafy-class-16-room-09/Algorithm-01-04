// Full verification - like 'Submit' on Programmers. To run samples only, run BojClassroomAssignmentTest.
...
public class BojClassroomAssignmentSubmit {
    static final String NAME = "BojClassroomAssignment";
