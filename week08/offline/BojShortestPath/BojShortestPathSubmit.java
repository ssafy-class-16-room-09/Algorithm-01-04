// Full verification - like 'Submit' on Programmers. To run samples only, run BojShortestPathTest.
...
public class BojShortestPathSubmit {
    static final String NAME = "BojShortestPath";
