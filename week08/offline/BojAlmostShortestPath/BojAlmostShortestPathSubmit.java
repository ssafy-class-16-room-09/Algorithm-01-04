// Full verification - like 'Submit' on Programmers. To run samples only, run BojAlmostShortestPathTest.
...
public class BojAlmostShortestPathSubmit {
    static final String NAME = "BojAlmostShortestPath";
