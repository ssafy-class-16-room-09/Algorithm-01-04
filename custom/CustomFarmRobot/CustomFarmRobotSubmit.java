// Full verification - like 'Submit' on Programmers. To run samples only, run CustomFarmRobotTest.
...
public class CustomFarmRobotSubmit {
    static final String NAME = "CustomFarmRobot";
