// Full verification - like 'Submit' on Programmers. To run samples only, run CustomPowerGeneratorTest.
...
public class CustomPowerGeneratorSubmit {
    static final String NAME = "CustomPowerGenerator";
