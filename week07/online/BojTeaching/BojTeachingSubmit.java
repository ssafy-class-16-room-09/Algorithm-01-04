// Full verification - like 'Submit' on Programmers. To run samples only, run BojTeachingTest.
...
public class BojTeachingSubmit {
    static final String NAME = "BojTeaching";
