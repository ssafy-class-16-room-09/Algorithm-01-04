// Full verification - like 'Submit' on Programmers. To run samples only, run BojSubsequenceSumTest.
...
public class BojSubsequenceSumSubmit {
    static final String NAME = "BojSubsequenceSum";
