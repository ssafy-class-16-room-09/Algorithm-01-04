// Full verification - like 'Submit' on Programmers. To run samples only, run BojTravelingSalesmanTest.
...
public class BojTravelingSalesmanSubmit {
    static final String NAME = "BojTravelingSalesman";
