// Full verification - like 'Submit' on Programmers. To run samples only, run BojMazeEscapeTest.
...
public class BojMazeEscapeSubmit {
    static final String NAME = "BojMazeEscape";
