// Full verification - like 'Submit' on Programmers. To run samples only, run BojKnapsackCountTest.
...
public class BojKnapsackCountSubmit {
    static final String NAME = "BojKnapsackCount";
