// Full verification - like 'Submit' on Programmers. To run samples only, run BojOrdinaryKnapsackTest.
...
public class BojOrdinaryKnapsackSubmit {
    static final String NAME = "BojOrdinaryKnapsack";
