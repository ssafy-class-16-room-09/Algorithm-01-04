// Full verification - like 'Submit' on Programmers. To run samples only, run BojMedianTellerTest.
...
public class BojMedianTellerSubmit {
    static final String NAME = "BojMedianTeller";
